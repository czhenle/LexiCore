...
class _AuthScreenState extends State<AuthScreen>
  ...
  bool _rememberMe = true; // stay logged in unless the user opts out
  ...
  Future<void> _signIn() async {
    ...
    try {
      await _supabaseService.signIn(_emailCtrl.text.trim(), _passwordCtrl.text);
        ...
        child: Stack(
          ...
          children: [
            ...
            const Positioned(
              top: 150,
              left: -20,
              child: Icon(Icons.cloud_rounded, color: Colors.white, size: 80),
            ),
            const Positioned(
              top: 350,
              right: -30,
              child: Icon(Icons.cloud_rounded, color: Colors.white, size: 100),
            ),
